  ...
  const expenseSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        `https://ajay-singh-f6aa8-default-rtdb.firebaseio.com/Expense/${userId}.json`,
        {
          method: "POST",
    ...
    //   const responseData = await response.json();
      const expenseDataWithId = { ...expenseData};
    ...
    <>
      ...
      >
        <Form
          ...
          className=" bg-red d-flex flex-row"
        >
          <Form.Group>
          ...
          <Button type="submit" className="mx-5 d-block my-0">
            +Add
          </Button>
        </Form>
